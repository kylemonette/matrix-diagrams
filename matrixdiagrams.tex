% matrixdiagrams.tex
% A LaTeX package for drawing schematic matrix diagrams in TikZ.
% 
% SOURCE CODE:
% https://github.com/kylemonette/matrix-diagrams
%
% AUTHOR:
% Kyle Monette - https://kylemonette.github.io
%
% LICENSE:
...
\texttt{matrixdiagrams} draws schematic matrix diagrams (bracketed boxes with
diagonals, shaded blocks, labels, and partition lines) directly in TikZ, for
typesetting matrix decompositions.
...
automatically adapts to the diagram's scale and aspect ratio. The sections
